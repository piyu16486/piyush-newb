...
function* handleGetSoftSanctionClientList() {
  try {
    const url = `${API_URL}/client-info-master/soft-sanction/client/list`;
    const response: ISoftSanctionClientListResponse = yield call(() => fetch(url).then(res => res.json()));
